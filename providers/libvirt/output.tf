...
output "cluster_nodes" {
  ...
  value = {
    ...
    ssh_first_master = "ssh -o StrictHostKeyChecking=no -i env/${var.infra_provider}/${terraform.workspace}/.key.private ${var.cluster.username}@${local.vm_operator_endpoints[local.first_master_name]}"
  }
}
